...
export async function GET(req: NextRequest, { params }: Params) {
  ...
  try {
    const pedido = obtenerPedido(Number(params.id));
...
export async function PUT(req: NextRequest, { params }: Params) {
  ...
  try {
    ...
    const actualizado = actualizarPedido(Number(params.id), items, observaciones);
...
export async function DELETE(req: NextRequest, { params }: Params) {
  ...
  try {
    ...
    const cancelado = cancelarPedido(Number(params.id));
